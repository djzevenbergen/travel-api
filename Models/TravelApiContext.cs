...
namespace TravelApi.Models
{
  public class TravelApiContext : DbContext
  {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
      ...
      .HasData(
        new Rating {RatingId = 1, Stars = 7, PlaceId = 2, UserId = 3, Comments = "no basis for opinion"},
        new Rating {RatingId = 2, Stars = 2, PlaceId = 3, UserId = 3, Comments = "never been here"}
      );
    }
  }
}